...
class Ui_Game(object):
    def setupUi(self, Game):
        ...
        self.pushButton.clicked.connect(lambda: self.check("scissors"))
        ...
        self.pushButton_4.clicked.connect(lambda: self.check("paper"))
        ...
        self.pushButton_2.clicked.connect(lambda: self.check("rock"))
...
"color: rgb(85, 255, 127);")
    ...
    def check(self, user_choice):
        ...
        if result == "You win!":
            self.lineEdit.setStyleSheet("color: blue; font-size: 16pt")
        else:
